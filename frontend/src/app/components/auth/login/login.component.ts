...
@Component({
      ...
      <div class="auth-box">
        ...
        <div class="form-wrapper">
          ...
          <div *ngIf="isForgot" class="space-y-4">
            ...
            <form *ngIf="forgotStep === 1" [formGroup]="forgotForm" (ngSubmit)="requestOtp()" class="space-y-4">
              <p class="form-desc">
                Enter your registered email address. We will generate a verification OTP to reset your password.
              </p>
              
              <div class="field-group">
                <label class="input-label">Email Address</label>
                <input type="email" formControlName="mobile" placeholder="e.g. admin@buildtrack.io" class="input-field">
              </div>

              <div class="grid-2">
                <button type="button" class="shortcut-btn" (click)="toggleForgot(false)" style="padding: 12px;">Back to Login</button>
                <button type="submit" class="submit-btn" [disabled]="loading">
  ...
  styles: [`
    .auth-container {
      ...
      background-image: url('https://res.cloudinary.com/b6pdv15b/image/upload/v1788370295/ChatGPT_Image_Sep_2_2026_11_00_06_PM_x3c5xe.png');
  ...
  requestOtp() {
    ...
    this.authService.forgotPassword(data).subscribe({
      next: (res: any) => {
        this.loading = false;
        this.forgotStep = 2;
        this.showToast(res.msg || 'Verification code sent to your registered email address. Please check your inbox.', 'success');
      },
      error: (err: any) => {
        this.loading = false;
